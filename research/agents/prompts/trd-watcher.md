...
1. `memory/project_context.md` — project architecture and patterns
2. `memory/feedback_backend_standards.md` — backend conventions
3. `memory/feedback_frontend_standards.md` — frontend conventions
4. `memory/feedback_separation_of_concerns.md`
